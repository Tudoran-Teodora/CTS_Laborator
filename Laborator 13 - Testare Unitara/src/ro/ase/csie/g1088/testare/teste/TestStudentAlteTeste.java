...
import ro.ase.csie.g1088.testare.teste.categorii.TestImportant;
...
public class TestStudentAlteTeste {
	...
	public void testGetMediePerformance() throws ExceptieNota {
		...
		if(durata<=100) {
			assertTrue(true); //a trecut testul de perforamnta
		}else {
			fail("Calculul mediei dureaza mai mult de 100 milisecunde");
		}
	}
